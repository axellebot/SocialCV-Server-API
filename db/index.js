...
exports.entries                 = require('./entry.model');
exports.groups                  = require('./group.model');
exports.parts                   = require('./part.model');
exports.permissions             = require('./permission.model');
exports.profiles                = require('./profile.model');
exports.users                   = require('./user.model');