...
module.exports = function (app) {
    ...
    routeComputingTags.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerComputingTags.computingTags.post);
    routeComputingTags.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerComputingTags.computingTags.put);
    ...
    routeComputingTags.post(PATH_INDEX + ':' + PARAM_ID_COMPUTING_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerComputingTags.computingTag.post);
    routeComputingTags.put(PATH_INDEX + ':' + PARAM_ID_COMPUTING_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerComputingTags.computingTag.put);
    ...
    routeEducations.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerEducations.educations.post);
    routeEducations.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerEducations.educations.put);
    ...
    routeEducations.post(PATH_INDEX + ':' + PARAM_ID_EDUCATION, requireRole(ROLE_MEMBER), requireBodyData, controllerEducations.education.post);
    routeEducations.put(PATH_INDEX + ':' + PARAM_ID_EDUCATION, requireRole(ROLE_MEMBER), requireBodyData, controllerEducations.education.put);
    ...
    routeEntities.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerEntities.entities.post);
    routeEntities.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerEntities.entities.put);
    ...
    routeEntities.post(PATH_INDEX + ':' + PARAM_ID_ENTITY, requireRole(ROLE_MEMBER), requireBodyData, controllerEntities.entity.post);
    routeEntities.put(PATH_INDEX + ':' + PARAM_ID_ENTITY, requireRole(ROLE_MEMBER), requireBodyData, controllerEntities.entity.put);
    ...
    routeExperiences.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerExperiences.experiences.post);
    routeExperiences.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerExperiences.experiences.put);
    ...
    routeExperiences.post(PATH_INDEX + ':' + PARAM_ID_EXPERIENCE, requireRole(ROLE_MEMBER), requireBodyData, controllerExperiences.experience.post);
    routeExperiences.put(PATH_INDEX + ':' + PARAM_ID_EXPERIENCE, requireRole(ROLE_MEMBER), requireBodyData, controllerExperiences.experience.put);
    ...
    routeFrameworks.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworks.frameworks.post);
    routeFrameworks.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworks.frameworks.put);
    ...
    routeFrameworks.post(PATH_INDEX + ':' + PARAM_ID_FRAMEWORK, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworks.framework.post);
    routeFrameworks.put(PATH_INDEX + ':' + PARAM_ID_FRAMEWORK, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworks.framework.put);
    ...
    routeFrameworkTags.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworkTags.frameworkTags.post);
    routeFrameworkTags.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworkTags.frameworkTags.put);
    ...
    routeFrameworkTags.post(PATH_INDEX + ':' + PARAM_ID_FRAMEWORK_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworkTags.frameworkTag.post);
    routeFrameworkTags.put(PATH_INDEX + ':' + PARAM_ID_FRAMEWORK_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerFrameworkTags.frameworkTag.put);
    ...
    routeInterests.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerInterests.interests.post);
    routeInterests.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerInterests.interests.put);
    ...
    routeInterests.post(PATH_INDEX + ':' + PARAM_ID_INTEREST, requireRole(ROLE_MEMBER), requireBodyData, controllerInterests.interest.post);
    routeInterests.put(PATH_INDEX + ':' + PARAM_ID_INTEREST, requireRole(ROLE_MEMBER), requireBodyData, controllerInterests.interest.put);
    ...
    routeLanguages.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerLanguages.languages.post);
    routeLanguages.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerLanguages.languages.put);
    ...
    routeLanguages.post(PATH_INDEX + ':' + PARAM_ID_LANGUAGE, requireRole(ROLE_MEMBER), requireBodyData, controllerLanguages.language.post);
    routeLanguages.put(PATH_INDEX + ':' + PARAM_ID_LANGUAGE, requireRole(ROLE_MEMBER), requireBodyData, controllerLanguages.language.put);
    ...
    routeLinks.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerLinks.links.post);
    routeLinks.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerLinks.links.put);
    ...
    routeLinks.post(PATH_INDEX + ':' + PARAM_ID_LINK, requireRole(ROLE_MEMBER), requireBodyData, controllerLinks.link.post);
    routeLinks.put(PATH_INDEX + ':' + PARAM_ID_LINK, requireRole(ROLE_MEMBER), requireBodyData, controllerLinks.link.put);
    ...
    routeLinkTags.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerLinkTags.linkTags.post);
    routeLinkTags.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerLinkTags.linkTags.put);
    ...
    routeLinkTags.post(PATH_INDEX + ':' + PARAM_ID_LINK_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerLinkTags.linkTag.post);
    routeLinkTags.put(PATH_INDEX + ':' + PARAM_ID_LINK_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerLinkTags.linkTag.put);
    ...
    routeOperatingSystems.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerOperatingSystems.operatingSystems.post);
    routeOperatingSystems.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerOperatingSystems.operatingSystems.put);
    ...
    routeOperatingSystems.post(PATH_INDEX + ':' + PARAM_ID_OPERATING_SYSTEM, requireRole(ROLE_MEMBER), requireBodyData, controllerOperatingSystems.operatingSystem.post);
    routeOperatingSystems.put(PATH_INDEX + ':' + PARAM_ID_OPERATING_SYSTEM, requireRole(ROLE_MEMBER), requireBodyData, controllerOperatingSystems.operatingSystem.put);
    ...
    routeProfiles.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProfiles.profiles.post);
    routeProfiles.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProfiles.profiles.put);
    ...
    routeProfiles.post(PATH_INDEX + ':' + PARAM_ID_PROFILE, requireRole(ROLE_MEMBER), requireBodyData, controllerProfiles.profile.post);
    routeProfiles.put(PATH_INDEX + ':' + PARAM_ID_PROFILE, requireRole(ROLE_MEMBER), requireBodyData, controllerProfiles.profile.put);
    ...
    routeProgrammingLanguages.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProgrammingLanguages.programmingLanguages.post);
    routeProgrammingLanguages.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProgrammingLanguages.programmingLanguages.put);
    ...
    routeProgrammingLanguages.post(PATH_INDEX + ':' + PARAM_ID_PROGRAMMING_LANGUAGE, requireRole(ROLE_MEMBER), requireBodyData, controllerProgrammingLanguages.programmingLanguage.post);
    routeProgrammingLanguages.put(PATH_INDEX + ':' + PARAM_ID_PROGRAMMING_LANGUAGE, requireRole(ROLE_MEMBER), requireBodyData, controllerProgrammingLanguages.programmingLanguage.put);
    ...
    routeProjects.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProjects.projects.post);
    routeProjects.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProjects.projects.put);
    ...
    routeProjects.post(PATH_INDEX + ':' + PARAM_ID_PROJECT, requireRole(ROLE_MEMBER), requireBodyData, controllerProjects.project.post);
    routeProjects.put(PATH_INDEX + ':' + PARAM_ID_PROJECT, requireRole(ROLE_MEMBER), requireBodyData, controllerProjects.project.put);
    ...
    routeProjectTags.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProjectTags.projectTags.post);
    routeProjectTags.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerProjectTags.projectTags.put);
    ...
    routeProjectTags.post(PATH_INDEX + ':' + PARAM_ID_PROJECT_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerProjectTags.projectTag.post);
    routeProjectTags.put(PATH_INDEX + ':' + PARAM_ID_PROJECT_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerProjectTags.projectTag.put);
    ...
    routeSoftwareFrameworks.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareFrameworks.softwareFrameworks.post);
    routeSoftwareFrameworks.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareFrameworks.softwareFrameworks.put);
    ...
    routeSoftwareFrameworks.post(PATH_INDEX + ':' + PARAM_ID_SOFTWARE_FRAMEWORK, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareFrameworks.softwareFramework.post);
    routeSoftwareFrameworks.put(PATH_INDEX + ':' + PARAM_ID_SOFTWARE_FRAMEWORK, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareFrameworks.softwareFramework.put);
    ...
    routeSoftwares.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwares.softwares.post);
    routeSoftwares.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwares.softwares.put);
    ...
    routeSoftwares.post(PATH_INDEX + ':' + PARAM_ID_SOFTWARE, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwares.software.post);
    routeSoftwares.put(PATH_INDEX + ':' + PARAM_ID_SOFTWARE, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwares.software.put);
    ...
    routeSoftwareTags.post(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareTags.softwareTags.post);
    routeSoftwareTags.put(PATH_INDEX, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareTags.softwareTags.put);
    ...
    routeSoftwareTags.post(PATH_INDEX + ':' + PARAM_ID_SOFTWARE_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareTags.softwareTag.post);
    routeSoftwareTags.put(PATH_INDEX + ':' + PARAM_ID_SOFTWARE_TAG, requireRole(ROLE_MEMBER), requireBodyData, controllerSoftwareTags.softwareTag.put);
    ...
    routeUsers.post(PATH_INDEX, requireRole(ROLE_ADMIN), requireBodyData, controllerUsers.users.post);
    routeUsers.put(PATH_INDEX, requireRole(ROLE_ADMIN), requireBodyData, controllerUsers.users.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_COMPUTING_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.computingTags.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_COMPUTING_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.computingTags.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_EDUCATIONS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.educations.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_EDUCATIONS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.educations.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_ENTITIES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.entities.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_ENTITIES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.entities.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_EXPERIENCES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.experiences.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_EXPERIENCES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.experiences.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_FRAMEWORKS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.frameworks.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_FRAMEWORKS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.frameworks.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_FRAMEWORK_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.frameworkTags.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_FRAMEWORK_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.frameworkTags.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_INTERESTS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.interests.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_INTERESTS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.interests.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_LANGUAGES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.languages.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_LANGUAGES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.languages.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_LINKS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.links.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_LINKS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.links.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_LINK_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.linkTags.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_LINK_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.linkTags.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_OPERATING_SYSTEMS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.operatingSystems.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_OPERATING_SYSTEMS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.operatingSystems.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROFILES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.profiles.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROFILES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.profiles.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROGRAMMING_LANGUAGES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.programmingLanguages.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROGRAMMING_LANGUAGES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.programmingLanguages.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROJECTS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.projects.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROJECTS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.projects.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROJECT_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.projectTags.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_PROJECT_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.projectTags.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_SOFTWARE_FRAMEWORKS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.softwareFrameworks.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_SOFTWARE_FRAMEWORKS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.softwareFrameworks.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_SOFTWARES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.softwares.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_SOFTWARES, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.softwares.put);
    ...
    routeUsers.post(PATH_INDEX + ':' + PARAM_ID_USER + PATH_SOFTWARE_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.softwareTags.post);
    routeUsers.put(PATH_INDEX + ':' + PARAM_ID_USER + PATH_SOFTWARE_TAGS, requireRole(ROLE_MEMBER), requireBodyData, controllerUsers.user.softwareTags.put);
